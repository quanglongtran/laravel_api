 ...
 */
     ...
     */ 
         ...
         * @static 
         */ 
        public static function jsonResponse($success = true, $message = '', $data = [], $code = 200)
        {
                        return \Illuminate\Routing\ResponseFactory::jsonResponse($success, $message, $data, $code);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function validateFailed($data = [])
        {
                        return \Illuminate\Routing\ResponseFactory::validateFailed($data);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Routing\ResponseFactory::updated($data);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Routing\ResponseFactory::deleted();
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Routing\ResponseFactory::restored();
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function resource($resource = null, $message = '')
        {
                        return \Illuminate\Routing\ResponseFactory::resource($resource, $message);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Routing\ResponseFactory::developing();
        }
